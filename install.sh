...
{ 
	...
	Install_socket
	mkdir -p $pluginPath
	wget -O $pluginPath/firewalls_list.py https://github.com/feinubin/bt/raw/master/firewalls_list.py -T 5
	...
	if [ "$pyVersion" == 2 ];then
		wget -O $pluginPath/btwaf_main.zip https://github.com/feinubin/bt/raw/master/btwaf_main.zip -T 5
	...
	wget -O $pluginPath/info.json https://github.com/feinubin/bt/raw/master/info.json -T 5
